...
def initiate() -> None:
    ...
    car_model_data = [
      ...
      {"name":"RAV4", "type":"Crossover", "year": 2023, "car_make":car_make_instances[4]},
      {"name":"Sienna", "type":"Minivan", "year": 2023, "car_make":car_make_instances[4]},
      {"name":"Tacoma", "type":"Pickup", "year": 2023, "car_make":car_make_instances[4]},
      {"name":"Tundra", "type":"Pickup", "year": 2023, "car_make":car_make_instances[4]},
